      ...
      <Card className="absolute right-[20px] top-4 flex w-80 flex-col items-center justify-center shadow-black/10 drop-shadow-xl dark:shadow-white/10">
        <CardHeader className="mt-8 flex items-center justify-center pb-2">
          <Image
            ...
            height={100}
            alt="user avatar"
            className="absolute -top-12 aspect-square size-24 rounded-full object-cover grayscale-0"
          />
        ...
        <CardFooter>
          <div>
            ...
            >
              ...
              <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-5 fill-foreground">
                <title>X</title>
